export const BotIcon = () => {
  return (
    ...
    >
      ...
      <rect x="7.25" y="3.25" width="1.5" height="1.75" rx="0.75" fill="currentColor" />
      {/* bot head (chat-bubble style with tail) */}
      <path
        d="M3 5.25A3.75 3.75 0 0 1 6.75 1.5h2.5A3.75 3.75 0 0 1 13 5.25v3.5A3.75 3.75 0 0 1 9.25 12.5H7.4l-2.2 1.65c-.34.26-.85.01-.85-.42V12.5A3.75 3.75 0 0 1 3 8.75v-3.5Z"
        fill="currentColor"
      />
      {/* eyes */}
      <circle cx="6.25" cy="8" r="0.9" fill="#fff" />
      <circle cx="9.75" cy="8" r="0.9" fill="#fff" />
      {/* mouth */}
      <rect x="6" y="9.9" width="4" height="1.2" rx="0.6" fill="#fff" />
    </svg>
  );
};
...
export const UserIcon = () => {
  return (
    ...
    >
      {/* head */}
      <circle cx="8" cy="4.75" r="3" fill="currentColor" />
      {/* shoulders/base */}
      <path
        d="M2 14c0-3.314 2.686-6 6-6s6 2.686 6 6H2Z"
        fill="currentColor"
      />
    </svg>
  );
